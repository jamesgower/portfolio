  ...
  return (
    <div className="about__container" id="about-me">
      ...
      <p className="about__text">
        ...
        <b>Express.JS</b>, <b>React</b> (preferably with <b>TypeScript</b>, or
        alternatively <b>JavaScript</b>) and <b>Node.JS</b> - however I am fast learning
        and eager to try out new frameworks and languages to achieve an optimum solution
        for any project.
      </p>
      <Row>
        <Col lg={7}>
          ...
          <p className="about__text">
            I have completed multiple courses and achieved a variety of certifications in
            my programming journey so far. I attended West Kent College to complete a{" "}
            <b>Higher National Diploma in Computing</b>, and previous to that I completed
            a <b>Level 3 Extended Diploma in ICT Practitioners</b>.
          </p>
          <p className="about__text">
          ...
          <p className="about__text">
            ...
            FreeCodeCamp certifications. After completing these courses I created multiple
            projects to showcase these skills (which can be found{" "}
            <span
              role="button"
              tabIndex={0}
