                    ...
                    <div className="skills--container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                ...
                                <p className="skills--text">
                                    For creating my back-end API's or servers I have a preference of
                                    using <b>Node.js</b>, by utilising frameworks such as{" "}
                                ...
                                <p className="skills--text">
                                    I am also proficient in using <b>Webpack</b> for bundling all of
                                    my assets together, and using source control management systems
                            ...
                            <div className="col-md-6">
                                ...
                                <p className="skills--text">
                                    ...
                                    completed multiple projects where I have had to create and
                                    implement design ideas into a fully working applications.
                                </p>
                                <p className="skills--text">
                            ...
                            <div className="col-md-6">
                                ...
                                <p className="skills--text">
                                    To make sure my code is readable to all developers who interact
                                    with it I use tools such as Prettier and ESLint. These tools
                                    ensure that everything is formatted in a especially readable and
                                    consistent throughout the whole codebase.
                                </p>
                            </div>
                        </div>
                    </div>
